...
import { Panel, PanelHeader, PanelHeaderButton, Placeholder, PanelSpinner } from '@vkontakte/vkui';
        ...
        return (
            <Panel id={id}>
                ...
                {participantInfo === 'error' && (
                    <Placeholder icon={<img alt="Заглушка" className="emoji-placeholder" src={hi} />} header="Ошибка">
